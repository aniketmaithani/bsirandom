...
Wifi Hotspot Captive Portal Over The Web
...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:corsecotech/wifi-hotspot-web.git; cd wifi-hotspot-web; fab init
...
[contributing]: http://github.com/corsecotech/wifi-hotspot-web/tree/master/CONTRIBUTING.md
