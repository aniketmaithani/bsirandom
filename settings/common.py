# -*- coding: utf-8 -*-
"""Django settings for Wifi Hotspot  project.
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'wifi_hotspot.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "wifi_hotspot.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'wifi_hotspot.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = "wifi_hotspot.base.views.csrf_failure"
...
def get_release():
    ...
    release = wifi_hotspot.__version__
    try:
