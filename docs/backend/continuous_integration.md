...
## Setting up Wifi Hotspot  with Drone.io Continuous Integration
...
5. Select ` wifi-hotspot-web ` for your repo
...
psql -c "CREATE DATABASE wifi_hotspot;" -U postgres
...
1. Click ( "Deployment" )[https://drone.io/github.com/corsecotech/wifi-hotspot-web/admin/deployments#/]
...
4. Add `https://git.heroku.com:wifi_hotspot-dev.git` under the Application Git URL
...
8. To have deployment for other branches including testing and production repeat steps 3 --> 7 with:
    - wifi_hotspot-qa for branch qa
    - wifi_hotspot-prod for branch prod
